...
/**
 * @author equation
 * @author tangfan 新增logger
 * @author tangfan 2018/8/22 11:07 针对 map 与 mapList 对象实现深度对象拷贝。只要存在同名的属性，将针对该对象进行再拷贝。
 * @author tangfan 2018/8/23 17:02 fix: 修复递归时，如果是原始对象，则使用原始对象的初始值进行初始化 http://cs-fundamentals.com/java-programming/java-primitive-data-types.php
 * @description 实现各层POJO之间的复制
 */
